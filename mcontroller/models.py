...
'''
For pet project, I only need one model.
For future improvement, I can add User model with key and also controllers.
'''
...
class Masturbation(models.Model):
    ...
    #m_user = models.ForeignKey(User, related_name='masturbations', on_delete=models.DO_NOTHING)